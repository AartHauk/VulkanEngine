...
namespace engine {
    ...
    void setupDebugMessenger() {
        ...
        if (CreateDebugUtilMessegerEXT(INSTANCE, &createInfo, nullptr, &DEBUG_MESSENGER) != VK_SUCCESS) {
    ...
    void createLogicalDevice() {
        QueueFamilyIndicies indicies = findQueueFamilies(PHYSICAL_DEVICE);
        ...
        vkGetDeviceQueue(DEVICE, indicies.presentFamily.value(), 0, &GRAPHICS_QUEUE);
    }
    ...
    // Graphics Pipeline create else where

    void createCommandPool() {
        QueueFamilyIndicies queueFamilyIndicies = findQueueFamilies(PHYSICAL_DEVICE);
    ...
    void createColorResources() {
        ...
        createImage(SWAP_CHAIN_EXTENT.width, SWAP_CHAIN_EXTENT.height, 1, MSAA_SAMPLES, colorFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, colorImage, colorImageMemory);
    ...
    void createDepthResources() {
        ...
        createImage(SWAP_CHAIN_EXTENT.width, SWAP_CHAIN_EXTENT.height, 1, MSAA_SAMPLES, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
    ...
    VkResult CreateDebugUtilMessegerEXT(VkInstance instance, VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessanger) {
    ...
    int rateDeviceSuitability(VkPhysicalDevice device) {
        ...
        if (!querySwapChainSupport(device).adequate()) {
            return 0;
        }
