...
//  TODO Make main engine file with:
//      global device
...
std::unique_ptr<EngineTexture> loadTextureFromFile(const VkDevice device, const std::string texturePath) {
    ...
    std::unique_ptr<EngineTexture> image (new EngineTexture(device));
...
void createTextureImage (VkImage textureImage, const VkDevice device, const std::string texturePath) {
